 ...
 * It extends the Item class and has the ability to pair with another transistor.
...
public class Transistor extends Item{
     ...
     * to the location of the paired transistor if available, otherwise it drops the transistor.
